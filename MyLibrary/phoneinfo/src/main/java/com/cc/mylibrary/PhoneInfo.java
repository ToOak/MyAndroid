...
/**
 * Created by xushuailong on 2015/12/28.
 */
public class PhoneInfo {
    private String TAG = PhoneInfo.this.getClass().getSimpleName().toString();
